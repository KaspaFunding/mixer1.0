...
function generateBatContent(isPublic = false) {
...
kaspad.exe --utxoindex --rpclisten=127.0.0.1:16110 --rpclisten-borsh=127.0.0.1:17110 --perf-metrics --perf-metrics-interval-sec=1 --outpeers=128${upnpFlag}
...
async function ensureNodeRunning(forcePublic = null) {
  ...
  try {
    ...
    if (batExists) {
      ...
      const batContent = generateBatContent(isPublic);
